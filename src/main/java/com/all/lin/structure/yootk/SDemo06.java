...
class LinkImpl06<T> implements ILink06<T> {
...
public class SDemo06 { // 李兴华编程训练营：edu.yootk.com
    public static void main(String args[]) {
        ILink06<String> link = new LinkImpl06<String>() ;
