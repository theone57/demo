...
class LinkImpl08<T> implements ILink08<T> {
...
public class SDemo08 { // 李兴华编程训练营：edu.yootk.com
    public static void main(String args[]) {
        ILink08<String> link = new LinkImpl08<String>() ;
