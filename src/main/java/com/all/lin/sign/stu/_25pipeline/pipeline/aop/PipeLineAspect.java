package com.all.lin.sign.stu._25pipeline.pipeline.aop;
...
public class PipeLineAspect {
     ...
     * 定义阀门invoke切点
     */
    @Pointcut(value = "this(com.all.lin.sign.stu._25pipeline.pipeline.Valve) " +
            "&& execution(* invoke(com.all.lin.sign.stu._25pipeline.pipeline.model.PipeLineContext)) && args((pipeLineContext))",
