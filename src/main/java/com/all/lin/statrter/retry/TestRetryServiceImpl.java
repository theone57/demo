package com.all.lin.statrter.retry;
...
public class TestRetryServiceImpl {
    public static void main(String[] args) {
        boolean basicType = ClassUtil.isBasicType(Integer.class);
     ...
     */
    @Recover
    public int recover(Exception e, int code) throws Exception {
