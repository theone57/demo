...
class LinkImpl07<T> implements ILink07<T> {
...
public class SDemo07 { // 李兴华编程训练营：edu.yootk.com
    public static void main(String args[]) {
        ILink07<String> link = new LinkImpl07<String>() ;
